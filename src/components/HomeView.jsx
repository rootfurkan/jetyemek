...
export default function HomeView({ setCurrentTab, onApplyDiscount }) {
  ...
  return (
    <div className="space-y-10 animate-fade-in">
      ...
      <div className="sticky top-16 z-30 bg-surface/85 backdrop-blur-md py-4 border-b border-stone-200/40 flex gap-3 overflow-x-auto no-scrollbar items-center justify-between">
